      ...
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold flex items-center gap-4 mb-4">
            <span className="font-mono text-xl font-normal" style={{ color: "#dc2626" }}>05.</span>
            Writing
            <div
          ...
          <p className="text-muted-foreground text-lg ml-12">
            Thoughts on engineering, distributed systems, and building things at scale.
          </p>
        </motion.div>
              ...
              >
                ...
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    (e.currentTarget as HTMLElement).style.boxShadow = "0 0 14px rgba(245,158,11,0.2), inset 0 1px 0 rgba(255,255,255,0.06)";
                  }}
                  onMouseLeave={(e) => {
